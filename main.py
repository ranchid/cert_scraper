...
if __name__ == "__main__":
    ...
    parser.add_argument('-n', '--batch', type=int, default=os.getenv('BATCH_SIZE'), help="[Optional] Override maximum n-value on .env's each loop process(batch)")
    ...
    parser.add_argument('-pt', '--print_timeout', type=float, default=os.getenv('PRINT_TIMEOUT'), help="[Optional] Override .env's timeout for print session")
    parser.add_argument('-dt', '--download_timeout', type=float, default=os.getenv('DOWNLOAD_TIMEOUT'), help="[Optional] Override .env's timeout for download session")
